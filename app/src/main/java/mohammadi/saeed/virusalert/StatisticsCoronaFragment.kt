 ...
 * Use the [StatisticsCoronaFragment.newInstance] factory method to
...
class StatisticsCoronaFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment StatisticsCoronaFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            StatisticsCoronaFragment().apply {
